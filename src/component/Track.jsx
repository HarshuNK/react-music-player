...
function Track() {
    ...
    const [view,setView] = useState(false)  // handles player view
            ...
            <div className="row">
                {
                    ...
                    {
                        view ? <div id="player" className="justify-content-center aligin-items-center p-3">
                            ...
                            <div className="row">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <h6 className="text-center text-danger"> { track?.name }</h6>
