            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12 text-center p-5">
                        <div className="text-secondary">Search for an Artist</div>
                    </div>
                </div>
            </div>
        )
                                ...
                                <div className="card-body">
                                    <ul className="list-group">
                                        ...
                                        <li className="list-group-item">
                                            ...
                                            <span className="float-end text-success text-capitalize">{genres?.join(' ,')}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="card-footer">
                                    <Link to={`/track/${id}`} className="btn btn-success">Track</Link>
                                </div>
                            </div>
                        </div>
                    </div>
